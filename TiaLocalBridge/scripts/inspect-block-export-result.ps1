...
$types = @(
    'Siemens.Engineering.SW.Blocks.DocumentExportResult',
    'Siemens.Engineering.SW.Blocks.DocumentImportResultForBlocks',
    'Siemens.Engineering.SW.Blocks.SWImportOptions',
    'Siemens.Engineering.SW.Blocks.ImportDocumentOptions'
)
