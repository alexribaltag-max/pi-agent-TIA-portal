...
$types = @(
    'Siemens.Engineering.SW.Blocks.PlcBlockGroup',
    'Siemens.Engineering.SW.Blocks.PlcSystemBlockGroupComposition',
    'Siemens.Engineering.SW.Blocks.PlcSystemBlockGroup'
)
